module AdRoll
  module Api
    class Audience < AdRoll::Api::Service
      WHITELIST_PARAMS = %i[first_party third_party source categorized advertiser_id
      ...
      def crosschannel_lal_segments(params)
        call_api(:get, "#{__method__}/valid-segments", sanitize_params(params))
      end
