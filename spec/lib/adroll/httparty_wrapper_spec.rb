  ...
  describe 'query_string_normalizer proc' do
    context 'With simple params' do
      ...
      it "should normalize simple arrays and singular params" do
        expect(described_class.normalizer_proc.call(params)).to eq("singular=a_parameter&array=param1,param2,param3")
      end
    end
    ...
    context 'With spacing and arrays' do
      ...
      it "should normalize simple arrays and singular params" do
        expect(described_class.normalizer_proc.call(params)).to eq("singular=a%20parameter&array=param%201,param%202,param%203")
      end
    end
  end
end
